...
class EventsLsitViewController: MyUIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        if let request = self.request{
            if request == ListEventCell.Request.upcoming{
...
//    }
    ...
    func setupNavBarTitles() {
        ...
        if let request = self.request{
            if request == ListEventCell.Request.saved{
                topBarTitle.text = "My interesting events".localized
            }else if request == ListEventCell.Request.upcoming{
                topBarTitle.text = "My upcoming events".localized
            }
        }
